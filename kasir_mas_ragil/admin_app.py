...
with col_tb2:
    st.markdown('<div class="topbar"><div style="font-weight:800">🍜 Admin Kasir Mas Ragil</div></div>', unsafe_allow_html=True)
with col_tb3:
    if st.button("🚪 Logout"):
        st.session_state.login = False
        st.rerun()
...
st.markdown("---")
st.caption("© 2025 Mas Ragil — Admin Kasir 🍜 | Versi Full Final")
