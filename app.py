...
def admin_page():
    ...
    if menu=="Data Menu":
        ...
        if st.button("🖨️ Tampilkan Struk"):
            ...
            st.session_state.pending_sale={"kode":kode,"buyer":selected_buyer,"items":buyer_checkout,"total":total_final,"cashier":config.get("cashier"),"tanggal":datetime.now().strftime("%Y-%m-%d")}
