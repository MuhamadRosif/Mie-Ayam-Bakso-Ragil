# ==============================
# Kasir Mas Ragil 🍜 — Versi Final Clean & Enhanced
# ==============================
...
# -----------------------
# Admin Login (Dark Centered with Animation)
# -----------------------
...
with main_col:
    if page == "home":
        ...
        st.image("https://via.placeholder.com/800x400/071026/ffffff?text=Mie+Ayam+%26+Bakso+Mas+Ragil", use_column_width=True)  # Placeholder image
    elif page == "pesan":
        ...
        for item, harga in menu_makanan.items():
            ...
            with col3:
                qty = st.session_state.pesanan.get(item, 0)
                st.write(f"Qty: {qty}")
            with col4:
        ...
        if pesanan_aktif:
            st.write("**Pesanan Saat Ini:**", pesanan_aktif)
        ...
        st.write("**Fitur:** Login admin, pesan menu, pembayaran, struk, laporan, dan reset pesanan.")
